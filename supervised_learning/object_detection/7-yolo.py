...
class Yolo:
    ...
    def show_boxes(self, image, boxes, classes, scores, file_name):
        """
    ...
    def predict(self, folder_path):
        """
        Displays all images in a folder with detected boxes and returns predictions
        """
        ...
        for i in range(len(images)):
            ...
            b_pred, c_pred, s_pred = self.non_max_suppression(
                filtered_boxes, box_classes, box_scores
            )

            predictions.append((b_pred, c_pred, s_pred))

            file_name = os.path.basename(image_paths[i])
            self.show_boxes(images[i], b_pred, c_pred, s_pred, file_name)
